...
\begin{enumerate}[leftmargin=1.5em]
  ...
  \item Entity observation modes: schedule-driven per-window inputs and optional motion-blob \texttt{auto\_motion} heuristic.
...
When schedule input is unavailable, an optional \texttt{auto\_motion} mode can generate entity observations from foreground motion blobs.
...
\begin{enumerate}[leftmargin=1.5em]
  ...
  \item \texttt{auto\_motion} is a heuristic foreground-blob tracker and is not equivalent to full detector/tracker/re-identification quality.
\end{enumerate}
