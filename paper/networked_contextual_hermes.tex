...
\begin{enumerate}[leftmargin=1.5em]
  \item Dynamic event inference stack with taxonomy routing, configurable observation classifier fusion, and context-conditional Markov filtering.
  \item Online runtime diagnostics with live transition/posterior visualization and interactive context switching.
